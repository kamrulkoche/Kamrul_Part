...
const Footer = () => {
    return (
        <div>
            <div className="bg-[#27105C] mt-10 py-10 text-white ">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:justify-items-center items-center px-4 container mx-auto">
                    <div>
                        ...
                        <p className="mt-5   font-medium">We compared and reviewed the best money transfer web & apps based on  features, fees, transfer remittance, Me link for a quick and secure  payment option.</p>
                    </div>
