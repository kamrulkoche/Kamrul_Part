...
const Content = () => {
    return (
        <div className="flex flex-col container mx-auto px-20 ">
            <h1 className="text-4xl font-medium leading-normal text-black ">Seamless Money Transfer, Worldwide Connection</h1>
            <p className="text-[#393939] text-2xl font-medium mt-9  leading-normal mb-20">
            ...
            <div className="bg-[#723EEB]  relative  rounded-e-2xl">
                ...
                <div className="flex justify-end items-center p-10 gap-6">
                    <div className="bg-white rounded-3xl w-48">
                        <p className="px-4 py-2 text-center text-[#723EEB] font-medium  items-center ">How to get started </p>
                    </div>
                    <div className="bg-white rounded-full p-3 text-[#723EEB] font-medium">
                        <FiPlay />
                    </div>
                </div>
            </div>
